...
# python llama32_1b_latency_bench.py --model meta-llama/Llama-3.2-1B --input-tokens 1024 --output-tokens 1024 --dtype bf16 --attn sdpa --power-sample-ms 100

# ===== Results =====
# Prompt tokens        : 1024
# Generated tokens     : 1024 (requested 1024)
# Prefill (diagnostic) : 0.0621 s
# Time to first token  : 0.0309 s  (measured from generate() start; includes prefill)
# Total generation time: 25.5802 s
# Overall throughput   : 40.03 tok/s
# Steady-state throughput (excl. TTFB): 40.04 tok/s

# Output preview:
#  This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama

# ===== Power (GPU 0) =====
# Warmup:   avg 40.1 W | peak 96.0 W | dur ~10.00 s | energy ~401.4 J
# Prefill:  avg nan W | peak nan W | dur 0.06 s | energy ~nan J
# Generate: avg 55.0 W | peak 58.4 W | dur 25.58 s | energy ~1407.0 J


# python llama32_1b_latency_bench.py --model meta-llama/Llama-3.2-1B --input-tokens 1024 --output-tokens 512 --dtype bf16 --attn sdpa --power-sample-ms 100

# ===== Results =====
# Prompt tokens        : 1024
# Generated tokens     : 512 (requested 512)
# Prefill (diagnostic) : 0.0353 s
# Time to first token  : 0.0273 s  (measured from generate() start; includes prefill)
# Total generation time: 12.9883 s
# Overall throughput   : 39.42 tok/s
# Steady-state throughput (excl. TTFB): 39.43 tok/s

# Output preview:
#  This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama

# ===== Power (GPU 0) =====
# Warmup:   avg 41.6 W | peak 56.6 W | dur ~10.00 s | energy ~415.6 J
# Prefill:  avg 53.7 W | peak 53.7 W | dur 0.04 s | energy ~1.9 J
# Generate: avg 54.0 W | peak 73.0 W | dur 12.99 s | energy ~701.9 J

# python llama32_1b_latency_bench.py --model meta-llama/Llama-3.2-1B --input-tokens 1024 --output-tokens 256 --dtype bf16 --attn sdpa --power-sample-ms 100

# ===== Results =====
# Prompt tokens        : 1024
# Generated tokens     : 256 (requested 256)
# Prefill (diagnostic) : 0.0585 s
# Time to first token  : 0.0332 s  (measured from generate() start; includes prefill)
# Total generation time: 6.4170 s
# Overall throughput   : 39.89 tok/s
# Steady-state throughput (excl. TTFB): 39.94 tok/s

# Output preview:
#  This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama models. This is a latency measurement prompt for Llama

# ===== Power (GPU 0) =====
# Warmup:   avg 39.3 W | peak 53.9 W | dur ~10.00 s | energy ~392.8 J
# Prefill:  avg nan W | peak nan W | dur 0.06 s | energy ~nan J
# Generate: avg 54.9 W | peak 93.2 W | dur 6.42 s | energy ~352.2 J