...
void pref_RoPE_layer(
    ...
    // cout << "RoPE cos: ";
    // for(int s = 0; s < 4; s++){
    //     for(int i = 0; i < io_hidden_dim/2; i++){
    //         cout << PE_cos[s][i] << " ";
    //     }
    //     cout << endl;
    // }
    // cout << "..." << endl;
    // for(int s = max_seq_Len - 4; s < max_seq_Len; s++){
    //     for(int i = 0; i < io_hidden_dim/2; i++){
    //         cout << PE_cos[s][i] << " ";
    //     }
    //     cout << endl;
    ...
    //             // if(M==0 && H == 0 && k == 0) cout << "RoPE input/output data: ";
    //             // if(M==0 && H == 0 && k < 8) cout << "(" << temp_pack_0[0] << " " << temp_pack_1[0] << " " << out_pack_0[0] << " " << out_pack_1[0] << ")" ;
