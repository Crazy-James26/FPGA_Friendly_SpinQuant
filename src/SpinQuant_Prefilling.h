...
void pref_vo_temporal_distributor(
    ...
    decoder_block_loop: for (int block_id = 0; block_id < DECODER_LAYER_NUM; block_id++){
        // io_v_loop: for (int M = 0; M < seq_len/TOKEN_PARALLEL * KV_HIDDEN_DIM; M++){
        // #pragma HLS loop_tripcount min=1*512 max=1024/16*512
        // #pragma HLS PIPELINE II=1
        //     output_stream_v.write(input_stream_vo.read());
        // }
        
        // io_o_loop: for (int M = 0; M < seq_len/TOKEN_PARALLEL * HIDDEN_DIM; M++){
        // #pragma HLS loop_tripcount min=1*2048 max=1024/16*2048
        // #pragma HLS PIPELINE II=1
        //     output_stream_o.write(input_stream_vo.read());
        // }
