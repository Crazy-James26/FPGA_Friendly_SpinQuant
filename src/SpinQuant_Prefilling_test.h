...
void SpinQuant_Prefilling(
    ...
    tapa::stream<hls::vector<float, TOKEN_PARALLEL>, 4 * HIDDEN_DIM> iembed_stream_res0("iembed_stream_res0");
    ...
    .invoke(pref_block_output_drainer_sync, res0_stream, io_mmap, block_input_ready_stream, seq_len)
